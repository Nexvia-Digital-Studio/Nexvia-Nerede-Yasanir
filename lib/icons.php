<?php
/**
 * SVG ikon kütüphanesi — emoji yerine.
 * Her ikon 24x24 viewBox, stroke-based (Feather Icons tarzı).
 * Kullanım: <?= icon('globe', 16) ?>
 */
...
const ICONS = [
    ...
    'heart-pulse'=> '<path d="M3.5 13h6l1.5-3 3 6 1.5-3h5"/><path d="M19.07 4.93A10 10 0 0 0 6.99 3.34"/><path d="M4 6a10 10 0 0 0-.59 10.5l5.59 5.59a2 2 0 0 0 2.83 0l5.59-5.59A10 10 0 0 0 12 2"/>',
...
/**
 * SVG ikon döndürür.
 * @param string $name  ikon anahtarı
 * @param int    $size  px (width=height)
 * @param string $class ekstra CSS sınıfı
 */
function icon(string $name, int $size = 16, string $class = 'ic'): string
{
    $path = ICONS[$name] ?? ICONS['map-pin'];
